...
public class ExampleNaturalLanguageClassifier : MonoBehaviour
{
  ...
  private string classifierId = "3a84d1x62-nlc-768";
  private string inputString = "Is it hot outside?";

  void Start()
  {
    Debug.Log("Input String: " + inputString);
    naturalLanguageClassifier.Classify(classifierId, inputString, OnClassify);
  }
