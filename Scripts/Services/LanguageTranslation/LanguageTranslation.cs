...
namespace IBM.Watson.DeveloperCloud.Services.LanguageTranslation.v1
{
  ...
  public class LanguageTranslation : IWatsonService
  {
    ...
    {
      private LanguageTranslation service = null;
      private ServiceStatus callback = null;

      public CheckServiceStatus(LanguageTranslation languageTranslation, ServiceStatus serviceStatus)
      {
        service = languageTranslation;
