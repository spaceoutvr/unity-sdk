...
namespace IBM.Watson.DeveloperCloud.Utilities
{
  ...
  public class KeyEventManager : MonoBehaviour
  {
    ...
    private bool updateActivate = true;
    private Dictionary<int, string> keyEvents = new Dictionary<int, string>();
    #endregion
    ...
    /// </summary>
    public bool Active { get { return active; } set { updateActivate = value; } }
    /// <summary>
    ...
    {
      int code = ((int)key) | (((int)modifiers) << MODIFIER_SHIFT_BITS);
      if (eventType != "" && keyEvents.ContainsKey(code) && keyEvents[code] == eventType)
        return keyEvents.Remove(code);
