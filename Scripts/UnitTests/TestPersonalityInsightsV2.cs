...
namespace IBM.Watson.DeveloperCloud.UnitTests
{
  public class TestPersonalityInsightsV2 : UnitTest
  {
    ...
    bool getProfileTextTested = false;
    bool getProfileJsonTested = false;
